...
![Sample AI B-roll generated by Reel Studio](demo/broll-preview.gif)

<sub>*Cinematic B-roll from a real run — ten different scenes unified by one style block. See [`demo.md`](demo.md).*</sub>
